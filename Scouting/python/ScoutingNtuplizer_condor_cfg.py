...
ofi = 'scouting_ntuple_' + str(options.condInputNum) + '.root'
print ofi

process.TFileService=cms.Service("TFileService",
                                 fileName=cms.string(ofi),
...
process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring('file:' + runfile)
)
...
process.scoutingntuplizer.output_file_name = cms.string(ofi)
