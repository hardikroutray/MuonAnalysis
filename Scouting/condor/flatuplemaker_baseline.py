...
#file_mu = ROOT.TFile("./BPhi_mass2_ct5.root")                                                                                
#file_mu = ROOT.TFile("./scouting_ntuple_hits.root") 
#tree_mu = file_mu.Get('scoutingntuplizer')

file_mu = ROOT.TFile('/cms/routray/crab_output/muontuples_10percent_v2/ScoutingCaloMuon/ScoutingCaloMuon_Ntuples_Run2018A_v1/200308_060230/0000/scouting_ntuple_{0}.root'.format(sys.argv[1]))
tree_mu = file_mu.Get('scoutingntuplizer')

#outfile = ROOT.TFile('flat_dimuon_tree_2017_v5.root', 'recreate')
#outfile.cd()

outfile = TFile("flatdimuontrees_baselineselections_no_iso_no_dphidimudv/2018/A/flatdimuontree_{0}.root".format(sys.argv[1]), "recreate")
outfile.cd()
...
for i, event in enumerate(tree_mu):
    ...
    passL1 = passL1_DoubleMu4p5_SQ_OS_dR_Max1p2 + passL1_DoubleMu_15_7 + passL1_DoubleMu0er1p4_SQ_OS_dR_Max1p4
