...
file_mu = ROOT.TFile("/cms/scoutingmuon/hardik/condor_output/ggPhi_ntuples/ggPhi_m6_ct5_ntuple.root") 
...
outfile = ROOT.TFile('flat_dimuon_tree_ggPhi_mass6_ct5_baseline_noiso_v1.root', 'recreate')
outfile.cd()
